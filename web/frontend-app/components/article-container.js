  ...
  return (
    <div className={[styles.articleContainer, className].join(" ")}>
      <div className={styles.articleContent}>
        <h1 className={styles.theSubstantialRole}>
        ...
        <div className={styles.articleMeta}>
          <div className={styles.articleMetaLeft}>
            ...
            <div className={styles.readingTimeContainer}>
              <div className={styles.minuteRead}> 5 minute read </div>
            </div>
          </div>
          <div className={styles.articleMetaRight}>
            <div className={styles.articleCategory}>
              <div className={styles.categoryIcon} />
              <div className={styles.constructionUaeContainer}>
                <b className={styles.construction}>Construction | UAE</b>
        ...
        <div className={styles.articleDivider}>
          <div className={styles.articleDividerChild} />
        </div>
      </div>
      <div className={styles.loremIpsumIsSimplyContainer}>
        ...
        <p className={styles.whereDoesIt}>Where does it come from?</p>
        ...
        <p className={styles.theStandardChunk}>
        ...
        <p className={styles.whereCanI}>Where can I get some?</p>
        ...
        <p className={styles.thereAreMany}>
          ...
          chunks as necessary, making this the first true gener
        </p>
      </div>
    </div>
  );
